<!-- Tag line -->
<h3 align="center">NoteNest - A self-hosted note taking API</h3>

<!-- Badges -->
<p align="center">
    <a href="https://shields.io/" target="_blank">
        <img src="https://img.shields.io/github/languages/top/bwhybrow23/NoteNest?color=brightgreenn" alt="Main Lang"/>
  </a>
...
`git clone bwhybrow23/NoteNest`
2. Install the dependencies
`npm install`
3. Run the server
`node app.js`
4. Run your API requests
`http://localhost:3000/`

<!-- License & Contributing -->
## License and Contributing
The current license for this project is **Don't Be a Dick (DBAD)**. You can see the official license [here](https://github.com/bwhybrow23/NoteNest/blob/master/LICENSE.md)
